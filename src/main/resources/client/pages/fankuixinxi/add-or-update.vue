	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ff993310","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"none","display":"block","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="maijiazhanghaoChange" :value="maijiazhanghaoIndex"  :range="maijiazhanghaoOptions">
					<view :style='{"border":"2rpx solid #eeeeee","padding":"0 20rpx","color":"#666666","background":"#ffffff","width":"100%","lineHeight":"64rpx","fontSize":"28rpx"}' class="uni-input">{{maijiazhanghaoOptions[maijiazhanghaoIndex]}}</view>
				</picker>
			</view>
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">留言时间</view>
				<input :style='{"border":"2rpx solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"0px","flex":"1","background":"#ffffff","fontSize":"28rpx","lineHeight":"64rpx","height":"64rpx"}' v-model="ruleForm.liuyanshijian" placeholder="留言时间" @tap="toggleTab('liuyanshijian')"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
		...
		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="liuyanshijianConfirm" ref="liuyanshijian" themeColor="#333333"></w-picker>
	</view>
</view>
</template>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.liuyanshijian = this.$utils.getCurDateTime();
		...
		methods: {
			...
			// 下二随
			async maijiazhanghaoChange (e) {
				this.maijiazhanghaoIndex = e.target.value
				this.ruleForm.maijiazhanghao = this.maijiazhanghaoOptions[this.maijiazhanghaoIndex]
				let res = await this.$api.follow(`maijia`, `maijiazhanghao`,{
					columnValue: this.ruleForm.maijiazhanghao
				});
				if(res.data.maijiaxingming){
					this.ruleForm.maijiaxingming = res.data.maijiaxingming
				}
			},
			...
			// 日长控件选择日期时间
			liuyanshijianConfirm(val) {
				console.log(val)
				this.ruleForm.liuyanshijian = val.result;
				this.$forceUpdate();
			},
