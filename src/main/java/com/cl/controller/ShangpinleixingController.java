...
public class ShangpinleixingController {
    ...
    public R save(@RequestBody ShangpinleixingEntity shangpinleixing, HttpServletRequest request){
        if(shangpinleixingService.selectCount(new EntityWrapper<ShangpinleixingEntity>().eq("shangpinleixing", shangpinleixing.getShangpinleixing()))>0) {
            return R.error("商品类型已存在");
        }
